...
pub struct WsMarketLifecycleV2 {
    ...
    /// Identifier for the exchange shard the market lives on. Only present on
    ...
    /// Determines how floor_strike / cap_strike are interpreted. Present only
...
pub struct WsEventLifecycle {
    ...
    /// Required per the AsyncAPI; modeled as optional for defensive parsing.
    /// Added 2026-07-30.
    #[serde(default)]
    pub exchange_index: Option<u32>,
    #[serde(default)]
